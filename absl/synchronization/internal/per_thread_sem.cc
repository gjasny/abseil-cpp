...
ABSL_ATTRIBUTE_WEAK void ABSL_ANNOTATE_C_SYMBOL(AbslInternalPerThreadSemPost)(
    absl::base_internal::ThreadIdentity *identity) {
  absl::synchronization_internal::Waiter::GetWaiter(identity)->Post();
}

ABSL_ATTRIBUTE_WEAK bool ABSL_ANNOTATE_C_SYMBOL(AbslInternalPerThreadSemWait)(
